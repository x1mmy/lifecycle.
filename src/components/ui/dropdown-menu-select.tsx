...
// Root component that manages the dropdown menu select state and context
const DropdownMenuSelect = SelectPrimitive.Root;

// Groups related dropdown menu select items together (optional)
const DropdownMenuSelectGroup = SelectPrimitive.Group;

// Displays the selected value or placeholder text
const DropdownMenuSelectValue = SelectPrimitive.Value;

/**
 * DropdownMenuSelectTrigger Component
 *
 * The clickable button that opens the dropdown menu select.
 ...
 */
const DropdownMenuSelectTrigger = React.forwardRef<
...
DropdownMenuSelectTrigger.displayName = SelectPrimitive.Trigger.displayName;

/**
 * DropdownMenuSelectScrollUpButton Component
 *
 * Button that appears at the top of the dropdown when there are items above the visible area.
 * Allows users to scroll up through the dropdown menu select options.
 * Only visible when there are items to scroll to above the current view.
 */
const DropdownMenuSelectScrollUpButton = React.forwardRef<
...
DropdownMenuSelectScrollUpButton.displayName =
  SelectPrimitive.ScrollUpButton.displayName;

/**
 * DropdownMenuSelectScrollDownButton Component
 *
 * Button that appears at the bottom of the dropdown when there are items below the visible area.
 * Allows users to scroll down through the dropdown menu select options.
 * Only visible when there are items to scroll to below the current view.
 */
const DropdownMenuSelectScrollDownButton = React.forwardRef<
...
DropdownMenuSelectScrollDownButton.displayName =
  SelectPrimitive.ScrollDownButton.displayName;

/**
 * DropdownMenuSelectContent Component
 *
 * The dropdown container that holds all dropdown menu select options.
 ...
 */
const DropdownMenuSelectContent = React.forwardRef<
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      {...props}
    >
      <DropdownMenuSelectScrollUpButton />
      ...
      <DropdownMenuSelectScrollDownButton />
    </SelectPrimitive.Content>
  </SelectPrimitive.Portal>
));
DropdownMenuSelectContent.displayName = SelectPrimitive.Content.displayName;

/**
 * DropdownMenuSelectLabel Component
 *
 * Optional label component for grouping dropdown menu select items.
 * Provides semantic grouping and accessibility benefits.
 * Styled with proper spacing and typography.
 */
const DropdownMenuSelectLabel = React.forwardRef<
...
DropdownMenuSelectLabel.displayName = SelectPrimitive.Label.displayName;

/**
 * DropdownMenuSelectItem Component
 *
 * Individual selectable option within the dropdown menu select.
...
DropdownMenuSelectItem.displayName = SelectPrimitive.Item.displayName;

/**
 * DropdownMenuSelectSeparator Component
 *
 * Visual separator line between groups of dropdown menu select items.
 * Provides clear visual distinction between different sections of options.
 * Styled with subtle gray color and proper spacing.
 */
const DropdownMenuSelectSeparator = React.forwardRef<
...
DropdownMenuSelectSeparator.displayName = SelectPrimitive.Separator.displayName;

/**
 * Export all Dropdown Menu Select components for use throughout the application.
 *
 * Usage example:
 * ```tsx
 * import {
 ...
 * <DropdownMenuSelect>
 *   <DropdownMenuSelectTrigger>
 *     <DropdownMenuSelectValue placeholder="Select an option..." />
 *   </DropdownMenuSelectTrigger>
 *   <DropdownMenuSelectContent>
 *     <DropdownMenuSelectItem value="option1">Option 1</DropdownMenuSelectItem>
 *     <DropdownMenuSelectItem value="option2">Option 2</DropdownMenuSelectItem>
 *   </DropdownMenuSelectContent>
 * </DropdownMenuSelect>
 * ```
 */
export {
  ...
  DropdownMenuSelectTrigger,
  DropdownMenuSelectContent,
  DropdownMenuSelectLabel,
  DropdownMenuSelectItem,
  DropdownMenuSelectSeparator,
  DropdownMenuSelectScrollUpButton,
  DropdownMenuSelectScrollDownButton,
};
